(function(window, undefined)
{
    ...
    isStyleSheet = function()
    {
        ...
        for (var i = 0; i < styles.length; i++)
        {
            ...
            {
                // Filter out esri api stylesheets, otherwise cross-site scripting messages appear in IE8 and below.
                if (styles[i].href.indexOf("serverapi.arcgisonline.com") == -1)
                {
    ...
    xhr = function(url, callback, i)
    {
        ...
        try
        {
			...
			else
            {
                ...
                { //IE6 and IE7 need the "new function()" syntax to work properly
                    if (xhr.readyState === 4)
                    {
                        callback(xhr, i);
                    } // else { callback function on AJAX error }
    ...
    {
		// we're gonna check if our browser will let us use AJAX
